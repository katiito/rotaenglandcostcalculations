function printAnalysis(averted, totalcost, Numberofagegroups, NumberofagegroupsToSum, Numberofyears)
    ...
    for year = 1:Numberofyears
        ...
        for fld = flds1
         ...
         oo = sprintf('%.0f\t(%.0f,%.0f)\t%.0f\t(%.0f,%.0f)',...
                    averted.All.mean{year},...
                    averted.All.low{year},averted.All.high{year},...
                    round(totalcost.All.mean{year}, -3),...
